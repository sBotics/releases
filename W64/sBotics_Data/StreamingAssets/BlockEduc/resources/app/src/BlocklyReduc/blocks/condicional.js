...
Blockly.Constants.Logic.CONTROLS_IF_MUTATOR_MIXIN = {
    ...
    mutationToDom: function() {
        ...
        if (this.elseifCount_) {
            container.setAttribute('senaose', this.elseifCount_);
        }
        if (this.elseCount_) {
            container.setAttribute('senao', 1);
        }
        return container;
    },
    /**
    ...
    domToMutation: function(xmlElement) {
        this.elseifCount_ = parseInt(xmlElement.getAttribute('senaose'), 10) || 0;
        this.elseCount_ = parseInt(xmlElement.getAttribute('senao'), 10) || 0;
        this.rebuildShape_();
    },
    /**
