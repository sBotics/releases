...
bc.printLCD(3, bc.lightness((int)(3-1)).ToString());
if (sensor ==  "0 1 1 1 1" ) {
    bc.printLCD(2,  "Entrou 4" );
erro = 4;
}

else if (sensor ==  "0 0 1 1 1" ) {
    bc.printLCD(2,  "Entrou 3" );
erro = 3;
}

else if (sensor ==  "1 0 1 1 1" ) {
    bc.printLCD(2,  "Entrou 2" );
erro = 2;
}

else if (sensor ==  "1 0 0 1 1" ) {
    bc.printLCD(2,  "Entrou 1" );
erro = 1;
}

else if (sensor ==  "1 1 0 1 1" ) {
    bc.printLCD(2,  "Entrou 0" );
erro = 0;
}
